...
<Related links={[
  { title: 'DSPy', url: 'https://github.com/stanfordnlp/dspy' },
  { title: 'OPRO', url: 'https://github.com/google-deepmind/opro' },
  { title: 'ProTeGi', url: 'https://github.com/microsoft/LMOps/tree/main/prompt_optimization' },
  { title: 'Reflexion', url: 'https://github.com/noahshinn/reflexion' },
  { title: 'TextGrad', url: 'https://github.com/zou-group/textgrad' }
]} />
