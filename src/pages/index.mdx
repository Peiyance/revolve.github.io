...
<h2 style="text-align:center; font-family: 'Noto Sans', sans-serif;">Related Links</h2>
...
<ul style="font-family: 'Noto Sans', sans-serif;">
  <li>
    🔰 <a href="https://github.com/stanfordnlp/dspy" class="related-link">
      DSPy
    </a> 
    and 
  ...
  <li>
    🔰 <a href="https://github.com/microsoft/LMOps/tree/main/prompt_optimization" class="related-link">
      ProTeGi
    </a>: The term 'Textual Gradients' was inspired by ProTeGi’s prompt optimization methods.
  </li>
  <li>
    🔰 <a href="https://github.com/noahshinn/reflexion" class="related-link">
      Reflexion
    </a>: A self-reflection framework that demonstrated the power of text-based reflection in optimization.
  </li>
  <li>
    🔰 <a href="https://github.com/zou-group/textgrad" class="related-link">
      TextGrad
...
<style>
  /* Apply 'Noto Sans' font globally for the text */
  body {
