...
<div style="font-family: inherit; font-size: inherit; text-align:center; max-width: 400px; margin: 0 auto; word-break: break-word; line-height: 1.5;">
  We're excited to have you join our community! Whether you're interested in collaborating, sharing insights,<br> or exploring innovative solutions in trustworthy machine learning, there are many ways to get involved:
</div>
<GetInvolved />
