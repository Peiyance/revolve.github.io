...
<ul style="font-family: 'Noto Sans', sans-serif;">
  <li>
    🔰 <a href="https://github.com/stanfordnlp/dspy" 
           style="color:hsl(204, 86%, 53%) !important; text-decoration: none;"
           onmouseover="this.style.textDecoration='underline'" 
           onmouseout="this.style.textDecoration='none'">
      DSPy
    </a> 
    and 
    <a href="https://github.com/google-deepmind/opro" 
       style="color:hsl(204, 86%, 53%) !important; text-decoration: none;"
       onmouseover="this.style.textDecoration='underline'" 
       onmouseout="this.style.textDecoration='none'">
      OPRO
  ...
  <li>
    🔰 <a href="https://github.com/microsoft/LMOps/tree/main/prompt_optimization" 
           style="color:hsl(204, 86%, 53%) !important; text-decoration: none;"
           onmouseover="this.style.textDecoration='underline'" 
           onmouseout="this.style.textDecoration='none'">
      ProTeGi
  ...
  <li>
    🔰 <a href="https://github.com/zou-group/textgrad" 
           style="color:hsl(204, 86%, 53%) !important; text-decoration: none;"
           onmouseover="this.style.textDecoration='underline'" 
           onmouseout="this.style.textDecoration='none'">
      TextGrad
